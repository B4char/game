...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, group, x, y, scale, display_surface, color):
        ...
        self.action = 1  # 0 - blue, 1 - walk, 2 - fall, 3 - attack, 4 - death
        ...
        self.idle_timer = pygame.time.get_ticks()  # blue timer
        self.attack_timer = pygame.time.get_ticks()  # attack timer
        self.idle_attack_timer = pygame.time.get_ticks()  # blue after attack timer
